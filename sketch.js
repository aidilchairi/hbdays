...
var foto, bgStatic;
var txt = "H'bdays 🎉";
var name = "Aidil Chairi W."; 
var txt2 = "Semangat Menjalankan Hidup";
var sfxPop;

function preload() {
	foto = loadImage("assets/img/aidil.png");
	bgStatic = loadImage("assets/img/boneka.png");
...
function draw() {
	...
	pop();
	// teks 2
	text(txt2, imgX + (mouseX - width / 2) / 30, imgY - 170 + (mouseY - height / 2) / 30);
	pop();
	// balloons
